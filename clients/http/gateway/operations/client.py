...
class OperationsGatewayHTTPClient(HTTPClient):
    ...
    def get_operation_api(self, operation_id: str) -> Response:
        ...
        return self.get(
            ...
            extension=HTTPClientExtensions(route="/api/v1/operations/{operation_id}")
        )
    ...
    def get_operation_receipt_api(self, operation_id: str) -> Response:
        ...
        return self.get(
            ...
            # Явно передаём логическое имя маршрута
            extension=HTTPClientExtensions(route="/api/v1/operations/operation-receipt/{operation_id}")
        )
    ...
    def get_operations_api(self, query: GetOperationsQuerySchema) -> Response:
        ...
        return self.get(
            ...
            # Явно передаём логическое имя маршрута
            extension=HTTPClientExtensions(route="/api/v1/operations")
        )
    ...
    def get_operations_summary_api(self, query: GetOperationsSummaryQuerySchema) -> Response:
        ...
        return self.get(
            ...
            params=QueryParams(**query.model_dump(by_alias=True)),
            # Явно передаём логическое имя маршрута
            extension=HTTPClientExtensions(route="/api/v1/operations/operations-summary")
        )
